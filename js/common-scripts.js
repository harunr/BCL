...
(function($){
	$(function(){
        ...
        $(".choose-accordion").each(function(){
            var $this = $(this);
            $this.find(" > h4").on("click touch", function(){
                $(".choose-accordion").removeClass("choose-active")
                $(".choose-accordion-content").slideUp();
                if($this.find(".choose-accordion-content:visible").length){
                    $(".choose-accordion").removeClass("choose-active")
                    $(".choose-accordion-content").slideUp();
                }
                else{
                    ...
                    $(".choose-accordion-content").slideUp();
                    $this.find(" > .choose-accordion-content").slideDown();
                }
            })
        })
		...
		/* Jump to bottom  */
        $(function() {
            $('.hero-main a.scroll-btn[href*="#"]:not([href="#"])').click(function() {
